...
function autobuild()
{
    ...
    platformio ci --lib="." ${BOARDS_AVR} ${BOARDS_ARM} ${BOARDS_ESP} examples/Erriez7SegmentDisplayDemo/Erriez7SegmentDisplayDemo.ino
}
...
function generate_doxygen()
{
    ...
    DOXYGEN_PDF="ErriezRobotDyn4DigitDisplay.pdf"
